...
import com.quocanle.jetpacknoteapp.di.AppModule_ProvideAppDatabaseFactory;
import com.quocanle.jetpacknoteapp.di.AppModule_ProvideNotesDaoFactory;
import com.quocanle.jetpacknoteapp.viewmodel.NoteViewModel;
import com.quocanle.jetpacknoteapp.viewmodel.NoteViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMainApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MainApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(NoteViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends MainApplication_HiltComponents.ViewModelC {
    ...
    private NoteRepository noteRepository() {
      return new NoteRepository(singletonCImpl.provideNotesDaoProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.quocanle.jetpacknoteapp.viewmodel.NoteViewModel", ((Provider) noteViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.quocanle.jetpacknoteapp.viewmodel.NoteViewModel 
  ...
  private static final class SingletonCImpl extends MainApplication_HiltComponents.SingletonC {
    ...
    private Provider<NoteDatabaseDao> provideNotesDaoProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideNotesDaoProvider = DoubleCheck.provider(new SwitchingProvider<NoteDatabaseDao>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.quocanle.jetpacknoteapp.data.NoteDatabaseDao 
          return (T) AppModule_ProvideNotesDaoFactory.provideNotesDao(singletonCImpl.noteDatabase());
